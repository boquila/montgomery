...
impl Yolo11Head {
    pub fn forward_raw(&self, features: Yolo11Features) -> RawPredictions {
    ...
    pub fn forward(&self, features: Yolo11Features) -> DecodedPredictions {
...
impl Yolo11HeadConfig {
    ...
    pub fn init(&self, device: &Device) -> Yolo11Head {
