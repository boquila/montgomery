...
mod tests {
    ...
    latency_test!(
        yolo26n_measures_single_inference_latency,
        Yolo26NConfig,
        "yolo26n"
    );
    latency_test!(
        yolo26s_measures_single_inference_latency,
        Yolo26SConfig,
        "yolo26s"
    );
    latency_test!(
        yolo26m_measures_single_inference_latency,
        Yolo26MConfig,
        "yolo26m"
    );
    latency_test!(
        yolo26l_measures_single_inference_latency,
        Yolo26LConfig,
        "yolo26l"
    );
    latency_test!(
