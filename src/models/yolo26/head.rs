...
#[derive(Module, Debug)]
pub struct Yolo26Head<B: Backend> {
...
impl<B: Backend> Yolo26Head<B> {
    pub fn forward_raw(&self, features: Yolo26Features<B>) -> RawPredictions<B> {
    ...
    #[cfg(feature = "training")]
    pub fn forward_dual(&self, features: Yolo26Features<B>) -> DualRawPredictions<B> {
    ...
    pub fn forward(&self, features: Yolo26Features<B>) -> DecodedPredictions<B> {
