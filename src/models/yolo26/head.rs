...
/// directly. The training-only one2many branch is intentionally not implemented, and because the
/// one2one head is trained end-to-end, predictions are selected by top score without
